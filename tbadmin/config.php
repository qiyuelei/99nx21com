<?php
/*调用实例*/
//require_once("./class/mysql/db_class.php"); //引入数据库类文件
/*实例化类：*/
//$db=new mysql("localhost","root","","nx76com_www","conn","utf8");
...
$c = new TopClient;
$c->appkey = "21360207";
$c->secretKey = "95d84c29db89ae25e71015ca2a4d486e";

require_once("./class/function.php"); //引入数据库类文件
